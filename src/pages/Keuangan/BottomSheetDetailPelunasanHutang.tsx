...
interface BottomSheetDetailPelunasanHutangModel {
  hutang: HutangPelunasanModel | null,
  open: boolean,
  onClose(value: boolean): void,
}

export const BottomSheetDetailPelunasanHutang = (pParameter: BottomSheetDetailPelunasanHutangModel) => {
